...
def postgres_aws_dag():
    ...
    def upload_to_s3(source):
        s3_client.upload_file(source, 'depacinatitaniccsv', 'titanic.csv')
...
#note airflow automatically detects that write to postgres and uploading to
#s3 can be done in parallel
